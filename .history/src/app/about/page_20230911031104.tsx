          ...
          <div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
              <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                ...
                At Bridge Builder, our mission is to empower businesses to harness the full potential of Salesforce. We believe that a well-managed Salesforce database is the backbone of successful customer relationship management. 
                </p>
                <p className="mt-6 text-lleading-7 text-gray-600">
                Our goal is to provide top-notch Salesforce solutions that streamline operations, enhance productivity, and drive growth for our clients.
