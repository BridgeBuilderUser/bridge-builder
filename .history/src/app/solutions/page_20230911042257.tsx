    ...
    <BasePage>
      <BasePage.Hero>
        <div className="relative isolate overflow-hidden bg-gray-900 pb-16 pt-14 sm:pb-20">
          ...
          >
            <div
              className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr blue-gradient opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
              style={{
                clipPath:
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              ...
              <div className="text-center">
                ...
                Your Salesforce Success Starts Here
                </h1>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Our Salesforce experts will help you get the most out of your
              Salesforce investment.  We can help you with everything from
              implementation to custom development.  We can even help you
              with your data migration.  We have the experience to help you
              succeed.
            </p>
          </div>
        </div>
