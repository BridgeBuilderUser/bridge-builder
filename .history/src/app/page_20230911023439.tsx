...
import hero from '@/assets/img/salesforce-bridge-builders.avif'
import {
  ArrowUturnLeftIcon,
  Bars3Icon,
...
export default function Home() {
  return (
    <BasePage>
            ...
            <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                <h1 className="text-center text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
                  <span className="block text-white">Honest. Reliable. Practical.</span>
                  <span className="block text-indigo-200">
                  Partners
                  </span>
                </h1>
                <p className="mx-auto mt-6 max-w-lg text-center text-xl text-indigo-200 sm:max-w-3xl">
                  Maximize Salesforce. Minimize Hassle. Contact Us for Seamless CRM.
                </p>
        ...
        <div className="relative">
          <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
            <div className="mx-auto max-w-xl px-4 sm:px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0">
              <div>
                <div>
                  <span className="flex h-12 w-12 items-center justify-center rounded-md bg-gradient-to-r blue-gradient">
                    <InboxIcon
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-6">
                    <a
                      href="#"
                      className="inline-flex rounded-md border border-transparent bg-gradient-to-r blue-gradient bg-origin-border px-4 py-2 text-base font-medium text-white shadow-sm hover:from-purple-700 hover:to-indigo-700"
                    >
                      Get started
                    </a>
                  </div>
      ...
      <div className="bg-gradient-to-r blue-gradient">
