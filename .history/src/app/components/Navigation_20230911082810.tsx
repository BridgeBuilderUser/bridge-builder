      ...
      <div className="flex w-full max-w-[90vw] h-full gap-5">
        ...
        <nav
          className={
            `${isMobile ? "mobile" : ""}
            ${isOpen ? "open" : "closed"}
            fixed h-screen w-screen bg-white top-0 left-0`}
        >
        ...
        <div className="w-1/6 flex gap-5">
          <Link
            href="/contact"
            className="hidden flex items-center justify-center rounded-md border border-transparent bg-indigo-500 px-4 py-3 text-sm font-medium text-white shadow-sm hover:bg-opacity-70 sm:px-8"
          >
            Request A Demo
          </Link>
        </div>
