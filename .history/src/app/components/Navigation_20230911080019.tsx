  ...
  return (
    <header className="flex items-center justify-center p-3 sticky top-0 z-50 bg-white shadow-md w-full">
      <div className="flex w-full max-w-[90vw] h-full gap-5">
        ...
        <nav className="fixed h-screen w-screen bg-white top-0 left-0">
          <AiOutlineCloseCircle className="absolute top-5 right-5 h-10 w-10 text-indigo-500 cursor-pointer" />
