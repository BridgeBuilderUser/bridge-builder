      ...
      <div className="flex w-full max-w-[90vw] h-full gap-5">
        ...
        <nav
          className={
            `${isMobile ? "mobile" : ""}
            ${isOpen ? "open" : "closed"}
            fixed h-screen w-screen bg-white top-0 left-0 lg:h-full lg:w-full lg:static lg:flex lg:flex-row lg:justify-end lg:items-center lg:gap-5 lg:px-5 lg:py-3 lg:shadow-none lg:bg-transparent lg:top-auto lg:left-auto lg:bottom-auto lg:right-auto`}
        >
