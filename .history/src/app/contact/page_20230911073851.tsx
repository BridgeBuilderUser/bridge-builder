    ...
    <div className="bg-white">
      ...
      <main>
        <div className="bg-blue-gray-50">
          ...
          >
            <h2 className="text-3xl font-bold tracking-tight text-blue-gray-900" id="faq-heading">
        ...
        >
          <div className="lg:w-0 lg:flex-1">
            <h2 className="text-3xl font-bold tracking-tight text-blue-gray-900 sm:text-4xl" id="newsletter-heading">
          ...
          <div className="mt-8 lg:mt-0 lg:ml-8">
            <form className="sm:flex">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="w-full rounded-md border border-blue-gray-300 px-5 py-3 placeholder-blue-gray-400 shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 sm:max-w-xs"
        ...
        <div className="mx-auto max-w-md py-12 px-4 sm:max-w-7xl sm:px-6 lg:py-16 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-8 xl:col-span-1">
              <img
                className="h-10"
                src="https://tailwindui.com/img/logos/mark.svg?color=blueGray&shade=300"
                alt="Company name"
              />
              <p className="text-base text-blue-gray-500">
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-base font-medium text-blue-gray-900">Solutions</h3>
                ...
                <div className="mt-12 md:mt-0">
                  <h3 className="text-base font-medium text-blue-gray-900">Support</h3>
                  <ul role="list" className="mt-4 space-y-4">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-base font-medium text-blue-gray-900">Company</h3>
                  <ul role="list" className="mt-4 space-y-4">
                ...
                <div className="mt-12 md:mt-0">
                  <h3 className="text-base font-medium text-blue-gray-900">Legal</h3>
                  <ul role="list" className="mt-4 space-y-4">
