          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-base font-medium text-warm-gray-700">Solutions</h3>
                ...
                <div className="mt-12 md:mt-0">
                  <h3 className="text-base font-medium text-warm-gray-700">Support</h3>
                  <ul role="list" className="mt-4 space-y-4">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-base font-medium text-warm-gray-700">Company</h3>
                  <ul role="list" className="mt-4 space-y-4">
                ...
                <div className="mt-12 md:mt-0">
                  <h3 className="text-base font-medium text-warm-gray-700">Legal</h3>
                  <ul role="list" className="mt-4 space-y-4">
